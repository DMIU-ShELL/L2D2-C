...
'''commands_composuite = [
    ...
    # MIG 3 (0-9)
    ['MIG-c432df19-0894-5232-ac1c-9a3440fc267e', "python run_composuite.py 1 29502 -l -d 0.0 --exp_id='comp_agent3'"],

    # MIG 4 (0-10)
    ['MIG-e8f61a95-352a-56cc-b95d-0c35fc14e8bf', "python run_composuite.py 2 29503 -l -d 0.0 --exp_id='comp_agent4'"],

    # MIG 5 (0-11)
    ['MIG-35ecef79-db2e-590b-9e8c-2c07c787008e', "python run_composuite.py 3 29504 -l -d 0.0 --exp_id='comp_agent5'"],

    # MIG 6 (0-12)
    ['MIG-76cd8dd7-7703-5581-8ac5-a7ee81a402a0', "python run_composuite.py 4 29505 -l -d 0.0 --exp_id='comp_agent6'"],

    # MIG 7 (0-13)
    #['MIG-b35e1a68-f7a4-5ef9-b34a-1abf6d1f8c2e', "python run_composuite.py 5 29506 -l -d 0.0 --exp_id='comp_agent7'"],



    # MIG 8 (1-7)
    #['MIG-2d5b6364-fc42-587b-97c6-ee316a82e2f3', "python run_composuite.py 7 29507 -l -d 0.0 --exp_id='comp_agent8'"],

    # MIG 9 (1-8)
    #['MIG-4590f80d-be70-58e4-af75-eeb950255d4a', "python run_composuite.py 8 29508 -l -d 0.0 --exp_id='comp_agent9'"],

    # MIG 10 (1-9)
    #['MIG-e76a2a9b-9867-5f8a-b145-d857cd5ed8e2', "python run_composuite.py 9 29509 -l -d 0.0 --exp_id='comp_agent10'"],

    # MIG 11 (1-10)
    #['MIG-2593b912-5975-58e9-bc3d-495311cee807', "python run_composuite.py 0 39510 -l -d 0.0 --exp_id='comp_agent11' -r reference_eval.csv"],

    # MIG 12 (1-11)
    #['MIG-51069529-f343-59c6-bac7-a75648296e7b', "python run_composuite.py 1 39511 -l -d 0.0 --exp_id='comp_agent12' -r reference_eval.csv"],
...
'''commands_composuite = [
    ...
    # MIG 2 (0-8)
    ['MIG-4590f80d-be70-58e4-af75-eeb950255d4a', "python run_composuite.py 1 39501 -l -d 0.0 --exp_id='comp_agent2'"],

    # MIG 3 (0-9)
    ['MIG-e76a2a9b-9867-5f8a-b145-d857cd5ed8e2', "python run_composuite.py 2 39502 -l -d 0.0 --exp_id='comp_agent3'"],

    # MIG 4 (0-10)
    ['MIG-2593b912-5975-58e9-bc3d-495311cee807', "python run_composuite.py 3 39503 -l -d 0.0 --exp_id='comp_agent4'"],

    # MIG 5 (0-11)
    ['MIG-51069529-f343-59c6-bac7-a75648296e7b', "python run_composuite.py 4 39504 -l -d 0.0 --exp_id='comp_agent5'"],
...
# FOCCAL (Continualworld)
commands_metaworld = [
    # MIG 1 (0-7)
    ['MIG-c3ce33ce-ced8-5961-bb87-2b40eb100277', "python run_metaworld.py 0 29500 -l -d 0.0 --exp_id='meta_agent1'"],

    # MIG 2 (0-8)
    ['MIG-280489c4-1d98-5b07-b4f6-2fc85fc874fa', "python run_metaworld.py 1 29501 -l -d 0.0 --exp_id='meta_agent2'"],

    # MIG 3 (0-9)
    ['MIG-c432df19-0894-5232-ac1c-9a3440fc267e', "python run_metaworld.py 2 29502 -l -d 0.0 --exp_id='meta_agent3'"],

    # MIG 4 (0-10)
    ['MIG-e8f61a95-352a-56cc-b95d-0c35fc14e8bf', "python run_metaworld.py 3 29503 -l -d 0.0 --exp_id='meta_agent4'"],

    # MIG 5 (0-11)
    ['MIG-35ecef79-db2e-590b-9e8c-2c07c787008e', "python run_metaworld.py 4 29504 -l -d 0.0 --exp_id='meta_agent5'"],

    # MIG 6 (0-12)
    ['MIG-76cd8dd7-7703-5581-8ac5-a7ee81a402a0', "python run_metaworld.py 5 29505 -l -d 0.0 --exp_id='meta_agent6'"],

    # MIG 7 (0-13)
    #['MIG-b35e1a68-f7a4-5ef9-b34a-1abf6d1f8c2e', "python run_metaworld.py 6 29506 -l -d 0.0 --exp_id='meta_agent7'"],

    # MIG 8 (1-7)
    #['MIG-2d5b6364-fc42-587b-97c6-ee316a82e2f3', "python run_metaworld.py 7 29507 -l -d 0.0 --exp_id='meta_agent8'"],

    # MIG 9 (1-8)
    #['MIG-4590f80d-be70-58e4-af75-eeb950255d4a', "python run_metaworld.py 8 29508 -l -d 0.0 --exp_id='meta_agent9'"],

    # MIG 10 (1-9)
    #['MIG-e76a2a9b-9867-5f8a-b145-d857cd5ed8e2', "python run_metaworld.py 9 29509 -l -d 0.0 --exp_id='meta_agent10'"],




    # MIG 11 (1-10)
    #['MIG-2593b912-5975-58e9-bc3d-495311cee807', "python run_metaworld.py 10 29510 -l -d 0.0 --exp_id='meta_agent11'"],

    # MIG 12 (1-11)
    #['MIG-51069529-f343-59c6-bac7-a75648296e7b', "python run_metaworld.py 11 29511 -l -d 0.0 --exp_id='meta_agent12'"],

    # MIG 13 (1-12)
    #['MIG-187573d8-7df7-5e5f-87b2-c8b8f73c54e7', "python run_metaworld.py 12 29512 -l -d 0.0 --exp_id='meta_agent13'"]
]
...
if args.env == 'ctgraph':
    ...
    commands = commands_composuite
elif args.env == 'meta':
    commands = commands_metaworld
else:
