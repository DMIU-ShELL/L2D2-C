...
commands_composuite = [
    ...
    # MIG 7 (0-13)
    #['MIG-b35e1a68-f7a4-5ef9-b34a-1abf6d1f8c2e', "python run_composuite.py 6 29506 -l -d 0.0 --exp_id='comp_agent7'"],
...
# FOCCAL (CompoSuite)
commands_robosuite_fullcomm = [
    # MIG 1 (0-7)
    ['MIG-c3ce33ce-ced8-5961-bb87-2b40eb100277', "python run_robosuite.py 0 29500 -l -d 0.0 --exp_id='comp_agent1'"],

    # MIG 2 (0-8)
    ['MIG-280489c4-1d98-5b07-b4f6-2fc85fc874fa', "python run_robosuite.py 1 29501 -l -d 0.0 --exp_id='comp_agent2'"],

    # MIG 3 (0-9)
    ['MIG-c432df19-0894-5232-ac1c-9a3440fc267e', "python run_robosuite.py 2 29502 -l -d 0.0 --exp_id='comp_agent3'"],
]

commands_robosuite_nocomm = [
    # MIG 11 (1-10)
    ['MIG-2593b912-5975-58e9-bc3d-495311cee807', "python run_robosuite.py 0 39510 -l -d 0.0 --exp_id='comp_agent11' -r reference_eval.csv"],

    # MIG 12 (1-11)
    ['MIG-51069529-f343-59c6-bac7-a75648296e7b', "python run_robosuite.py 1 39511 -l -d 0.0 --exp_id='comp_agent12' -r reference_eval.csv"],

    # MIG 13 (1-12)
    ['MIG-187573d8-7df7-5e5f-87b2-c8b8f73c54e7', "python run_robosuite.py 2 39512 -l -d 0.0 --exp_id='comp_agent13' -r reference_eval.csv"]
]
...
elif args.env == 'robofull':
    commands = commands_robosuite_fullcomm
elif args.env == 'robono':
    commands = commands_robosuite_nocomm
else:
