...
commands_minigrid = [
    # MIG 1 (0-7)
    ['MIG-c8cbc779-6499-5d1f-86e7-ad789e047331', "python run_minigrid.py 0 28500 -l -d 0.0 --exp_id='mg_agent1'"],

    # MIG 2 (0-8)
    ['MIG-f6c4eed6-1edf-5515-8e0b-0a5521e81cbb', "python run_minigrid.py 1 28501 -l -d 0.0 --exp_id='mg_agent2'"],

    # MIG 3 (0-9)
    ['MIG-ae777ac5-da68-5606-8581-1878288224dc', "python run_minigrid.py 2 28502 -l -d 0.0 --exp_id='mg_agent3'"],

    # MIG 4 (0-10)
    ['MIG-b2a723b5-db7a-50d8-a267-70569dafe609', "python run_minigrid.py 3 28503 -l -d 0.0 --exp_id='mg_agent4'"],

    # MIG 5 (0-11)
    ['MIG-73000f9d-03d4-5dab-ad23-34b546569bdd', "python run_minigrid.py 4 28504 -l -d 0.0 --exp_id='mg_agent5'"],

    # MIG 6 (0-12)
    ['MIG-f86cf155-b80e-56da-92ed-03c78bf647c7', "python run_minigrid.py 5 28505 -l -d 0.0 --exp_id='mg_agent6'"],

    # MIG 7 (0-13)
    ['MIG-bfb3fc5a-8b5e-59c1-87e8-3468c995103d', "python run_minigrid.py 6 28506 -l -d 0.0 --exp_id='mg_agent7'"],
