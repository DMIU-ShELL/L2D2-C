...
'''
lifelong (continual) learning experiments with weight preservation (consolidation) in RL
'''
...
########## ctgraph
## dqn
def dqn_ctgraph_cl(name, env_config_path=None):
    config = Config()
...
if __name__ == '__main__':
    ...
    #dqn_ctgraph_cl(name=game, env_config_path=env_config_path)
